...
export const routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        beforeEnter: async (to, from, next) =>
          authBeforeEnter(to, from, next, "/chooseGender2"),
      },
      // {
      //   path: '/mbti',
      //   name: 'mbti',
      ...
      // },
      {
        ...
        beforeEnter: async (to, from, next) =>
          authBeforeEnter(to, from, next, "/exam"),
      },
      {
        path: "/exam2",
        name: "exam2",
        ...
        beforeEnter: async (to, from, next) =>
          authBeforeEnter(to, from, next, "/exam2"),
      },
      // ww 注释
      // {
      // 	path: '/goodsExam',
      ...
      // },
      {
        ...
        beforeEnter: async (to, from, next) =>
          authBeforeEnter(to, from, next, "/errorRecord"),
      },
      {
        path: "/collect",
        name: "collect",
...

      {
        ...
        beforeEnter: async (to, from, next) =>
          authBeforeEnter(to, from, next, "/coupon"),
      },
      // ww注释
      // {
      // 	path: '/get-coupon',
