<template>
    <div class="theme-orange">
        ...
        <div class="card-warper fit-warper"
            v-if="testPaperInfo?.introduce?.fit && testPaperInfo?.introduce?.fit.length >= 1">
...
@theme: linear-gradient(to bottom, #f6d365 0%, #fda085 100%);
                ...
                .right {
                    ...
                    .desc {
                        ...
                        &::after {
                            ...
                            width: 100%;
                            height: 1px; // 下划线的粗细
                            background-color: #f7e290; // 下划线的颜色
                            opacity: 0.3;
                            position: absolute;
