<template>
  <div class="mbti_pay">
    ...
    <div class="price_mid">
      <div class="js_choose">
        ...
        >
          ...
          <!-- <div class="p2" style="color: #000;">￥{{ (item.price - (priceInfo?.value ?
						priceInfo?.value : 0)).toFixed(2) }}<span style="color: rgb(85, 85, 85);">￥{{
		item.originalPrice }}</span></div> -->
          ...
          <div class="dikouxj" v-if="redPacketType != 0">
    ...
    <!-- <div class="price_zf" @click="confirm">
      <div class="wxzf">
        <img src="../../../../assets/images/wx2.jpg" class="wxzf-img" /><span
          style="margin-left: 10px"
          >支付</span
        >
      </div>
      <div class="p4">已有 6{{ getPeople }} 人购买</div>
    </div> -->
    ...
    <div class="new-price-rights">
      ...
      <div class="new-price-right-box">
        <div
          class="new-price-right-item"
          v-for="item in goods_list"
          :key="item.id"
          :class="{ through: !item.show }"
        >
          <div class="right-icon-wrapper">
            <div class="right-icon">
              <img :src="item.img" class="taro-img__mode-aspectfit" />
            </div>
          </div>
          <div class="right-txt right-txt-active">{{ item.name }}</div>
        </div>

        <!-- 				
				<div class="new-price-right-item  through">
					<div class="right-icon-wrapper ">
						<div class="right-icon "><img src="../../../../assets/images/detail.png"
								class="taro-img__mode-aspectfit"></div>
					</div>
					<div class="right-txt  right-txt-active"> 完整解读 </div>
				</div>
				<div class="new-price-right-item  ">
					<div class="right-icon-wrapper ">
						<div class="right-icon "><img src="../../../../assets/images/card.png"
				...
				<div class="new-price-right-item  ">
					<div class="right-icon-wrapper ">
						<div class="right-icon "><img src="../../../../assets/images/advantage.png"
								class="taro-img__mode-aspectfit"></div>
					</div>
				...
				<div class="new-price-right-item  through">
					<div class="right-icon-wrapper ">
						<div class="right-icon "><img src="../../../../assets/images/love.png"
								class="taro-img__mode-aspectfit">
						</div>
					</div>
				...
				<div class="new-price-right-item  through">
					<div class="right-icon-wrapper ">
						<div class="right-icon "><img src="../../../../assets/images/custom.png"
								class="taro-img__mode-aspectfit"></div>
					</div>
				...
				<div class="new-price-right-item through">
					<div class="right-icon-wrapper ">
						<div class="right-icon "><img src="../../../../assets/images/pro.png"
								class="taro-img__mode-aspectfit">
						</div>
					</div>
				...
				<div class="new-price-right-item  through">
					...
					<div class="right-txt  right-txt-active"> 爱情婚姻揭密
					</div>
				</div>
				<div class="new-price-right-item through">
					<div class="right-icon-wrapper ">
				...
				<div class="new-price-right-item one-line through">
					...
					<div class="right-txt  right-txt-active"> 荣格八维报告（含Ne Ni Se Si Te Ti Fe Fi）
					</div>
				</div> -->
      </div>
